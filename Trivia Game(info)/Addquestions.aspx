<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Addquestions.aspx.cs" Inherits="Trivia_Game_info_.Addquestions" %>
    ...
    <div class="main">
        <nav class="navbar navbar-expand-sm ">
         ...
         <ul class="navbar-nav" style="margin-left: 20%; font-size: 12px;">
              <li class="nav-item">
                <a class="nav-link" href="School.aspx">Home </a>
              </li>
         
              <li class="nav-item">
                <a class="nav-link" href="Addcatagories.aspx">Add catagories</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="Addquestion.aspx">Add Questions</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="#">Progress chart</a>
              </li>
            </ul>
          </nav>
...
<button class="btn btn-success">last quiz</button>
    ...
    <div class="container mt-5" id="formbg">
      <div class="row">
          <div class="col-12 text-center text-light bg-primary"><h1>Add Questions</h1></div>
      </div>
         <form runat="server" action="#" class="form">
                 <label class="mb-3 mt-3" for="">Select Catagory</label> &nbsp;&nbsp;&nbsp; <asp:dropdownlist runat="server" id="ddlTest">
     ...
     <asp:listitem text="General Knowledge" value="4"></asp:listitem>
     <asp:listitem text="English" value="5"></asp:listitem>
</asp:dropdownlist>
             <br />

              <label class="mb-3 mt-3" for="">ID</label><asp:TextBox runat="server" type="text" ID="Name" required ="true" class="form-control"></asp:TextBox>
              <label class="mb-3 mt-3" for="">QUESTION</label><asp:TextBox runat="server" type="text" ID="TextBox1" required ="true" class="form-control"></asp:TextBox>
              <label class="mb3 mt-3" for="">Option 01</label><asp:TextBox runat="server" type="text" ID="TextBox2" required ="true" class="form-control"></asp:TextBox>
              <label class="mb3 mt-3" for="">Option 02</label><asp:TextBox runat="server" type="text" ID="TextBox3" required ="true" class="form-control"></asp:TextBox>
              <label class="mb3 mt-3" for="">Option 03</label><asp:TextBox runat="server" type="text" ID="TextBox4" required ="true" class="form-control"></asp:TextBox>
              <label class="mb3 mt-3" for="">Option 04</label><asp:TextBox runat="server" type="text" ID="TextBox5" required ="true" class="form-control"></asp:TextBox>
              <label class="mb3 mt-3" for="">Correct Answer</label><asp:TextBox runat="server" type="text" ID="TextBox6" required ="true" class="form-control"></asp:TextBox>
