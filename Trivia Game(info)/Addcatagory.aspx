<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Addcatagory.aspx.cs" Inherits="Trivia_Game_info_.Addcatagory" %>
...
<button class="btn btn-success">last quiz</button>
    ...
    <div class="container mt-5" id="formbg">
      <div class="row">
          <div class="col-12 text-center text-light bg-primary"><h1>Add catagories</h1></div>
      </div>
         <form action="#" class="form">
              <label class="mb-3 mt-3" for="">ID</label><asp:TextBox runat="server" ID="id" type="text" required="true" class="form-control"></asp:TextBox>
              <label class="mb-3 mt-3" for="">CATAGORY NAME</label><asp:TextBox runat="server" ID="mail" type="text" required="true" class="form-control"></asp:TextBox>
               
            
              
              <br>
               <asp:Button runat="server" ID="b1" Text="Add Catagory"  OnClick="b1_Click"/>
          </form>
      </div>
      <br><br>
